...
pros::MotorGroup left_motor_group({3, 12, 13},pros::Color::green);    
// right motor group with ports 8,18, and (20 reversed)
pros::MotorGroup right_motor_group({8, -20, 18},pros::Color::green);  
lemlib::Drivetrain drivetrain(&left_motor_group, &right_motor_group, 11.0, , lemlib::Omniwheel::NEW_325,600,2); 
